...
export const FooterIconsContainer = ({ children }: FooterProps) => {
  <div className="flex flex-row gap-2">{children}</div>;
};

export const FooterLinksContainer = ({ label, children }: FooterProps) => (
  <div className="flex flex-col gap-3 items-center">
    <span className="text-xl font-semibold">{label}</span>
    <ul className="flex flex-col gap-2 items-center text-gray">{children}</ul>
  </div>
);

export const FooterLink = ({ children }: FooterProps) => <li className="">{children}</li>;

export const Footer = () => {
  return (
    <footer className="flex flex-col md:flex-row md:justify-evenly md:items-start p-10 items-center gap-10 bg-very_dark_violet text-white">
